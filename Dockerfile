...
COPY app/ .
CMD ["/usr/local/bin/gunicorn", "-w 4", "-k geventwebsocket.gunicorn.workers.GeventWebSocketWorker", "--graceful-timeout 3600000", "--timeout 999999999", "--bind 0.0.0.0:8000", "flask_main:app"]