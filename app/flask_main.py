...
def online_game():
    return render_template("playing_online/online_game.html")
...
def lobby():
    ...
    try:
        ...
        if gameplay.validators().isHost(request.cookies.get("SID"),request.args.get("gid"),activeGames): #Renders host-only controls if the user is the host
            host_content = Markup(render_template("host_only_playing_online/lobby.html"))
...
def game():
    ...
    try:
        ...
        if gameplay.validators().isHost(userID,gameID,activeGames):
            return render_template("playing_online/host_only/playing_online_host.html", grid=usersGrid, hostNick=hostNick, mySID=mySID)
        else:
            return render_template("playing_online/online_game.html", grid=usersGrid, hostNick=hostNick, mySID=mySID)
...
#=========================================================#
#^ Main app execution ^#
testGame = activeGames(gameID=1,hostSID=1,gridSettings='{"GRID_X": 5, "GRID_Y": 5}',itemSettings='{"M5000":1,"M1000":0,"M500":0,"M200":18,"itmShield":1,"itmKill":0,"itmSteal":0,"itmMirror":1,"itmBomb":2,"itmBank":1,"itmSwap":1,"itmGift":0}', resultsScores='{"tuser1": 5000, "testifications2": 5587, "tuser2":4000, "test3": 2870, "test4": 2587, "test5": 3540, "test6": 1234, "WWWWWWWWWWWWWWW": 5343, "test8": 1750, "test9": 4300, "test10": 2900, "test11": 2800, "test12": 1750, "test13": 1700, "test14": 3900, "test15": 1500, "test16": 4700, "test17": 3500}') #Creates active game for test purposes
